import styles from "./CuteTerminal.module.scss";

export default function CuteTerminal({ title = "typescript-playground", text = "", prompt = ">", showCopy = true }) {
    ...
    return (
        <div className={styles.cuteTerminalWrapper}>
            <div className={styles.cuteTerminalHeader}>
                <div className={styles.cuteTerminalButtons}>
            ...
            <div className={styles.cuteTerminalBody}>
                <pre>
                    {lines.map((line, idx) => (
